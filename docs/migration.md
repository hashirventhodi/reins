...
The pipeline is strictly additive. Nothing outside the paths listed in
step 2 is created or modified; rollback is deletion.
...
tests/test_m5_acceptance.py::test_migration_and_rollback_leave_no_residue).
