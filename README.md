...
(Tasks get short sequential ids — `001-add-a-request-id-header` — so you
can refer to one by number, by id, or by any unambiguous fragment of its
title. An ambiguous reference lists the candidates instead of guessing.)
